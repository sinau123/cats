<template>
  <div
    class="footer bg-gray-100 font-montserrat text-sm font-semibold text-gray-800 p-4 xs-only:text-sm pt-10 mt-16"
  >
    <div
      class="flex xs-only:flex-col-reverse xs-only:items-end justify-between container m-auto"
    >
      <div class="flex items-end">
        <span> © 2021 by MIAUMI Cattery</span>
      </div>
      <div class="flex flex-1 flex-col items-end xs-only:mb-4">
        <div class="flex xs-only:mb-4 mb-5">
          <a
          ...
          >
            <svg
              ...
              viewBox="0 0 24 24"
              fill="currentColor"
              class="w-10 text-gray-800 hover:text-instagram transition-colors ease-linear duration-200"
          ...
          >
            <svg
              ...
              viewBox="0 0 24 24"
              fill="currentColor"
              class="w-10 text-gray-800 hover:text-facebook transition-colors ease-linear duration-200"
            >
              <path
        ...
        <div class="text-right">
          ...
          <a
            class="hover:text-opacity-80 hover:text-green-700 text-green-600"
